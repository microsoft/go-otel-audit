...
func (o *OperationType) UnmarshalMsgpack(b []byte) error {
	...
	if len(b) < 2 {
		return fmt.Errorf("OperationType: msgpack data too short (%d bytes)", len(b))
	}
	s := bytesToStr(b[1:])
...
func (o *OperationCategory) UnmarshalMsgpack(b []byte) error {
	if len(b) < 2 {
		return fmt.Errorf("OperationCategory: msgpack data too short (%d bytes)", len(b))
	}
	s := bytesToStr(b[1:])
...
func (o *OperationResult) UnmarshalMsgpack(b []byte) error {
	if len(b) < 2 {
		return fmt.Errorf("OperationResult: msgpack data too short (%d bytes)", len(b))
	}
	s := bytesToStr(b[1:])
...
func (o *CallerIdentityType) UnmarshalMsgpack(b []byte) error {
	if len(b) < 2 {
		return fmt.Errorf("CallerIdentityType: msgpack data too short (%d bytes)", len(b))
	}
	s := bytesToStr(b[1:])
